/*! htmx 2.0.4 - vendored, not linked (CSP allows only 'self').
 * Bump deliberately: the htmx-config key includeIndicatorStyles in
 * base.html is renamed in htmx 4, and without it htmx injects a
 * <style> block that style-src 'self' rejects on every page.
 * Renovate does not track vendored assets. */
